...
from tkinter import *
from . import tkextras


class AboutDialog(Toplevel):
    """About dialog for IDLE - optionally modal"""
    def __init__(self, parent, title, _htest=False, must_be_modal=True,
        ...
        self.parent = parent
        # keep???  self.bind('<Return>',self.close) #dismiss dialog
        # keep???  self.bind('<Escape>',self.close) #dismiss dialog
        if must_be_modal:
            self.wait_window()
